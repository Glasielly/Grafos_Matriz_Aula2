...
public class Grafo<T extends Comparable<T>, E extends Comparable<E>> {
    ...
    public int qtdComponentes() {
        ...
        return buscaEmLargura(0, isDescobertos, 0);
    }

    public int buscaEmLargura(int origem, boolean[] isDescobertos, int qtd) {
        ...
        if (!todosEncontrados) {
            return buscaEmLargura(i, isDescobertos, qtd++) + 1;
        } else {
            return 1;
        }
    }
...
//        boolean[] descobertos = buscaEmLargura(0);
//        for (boolean descoberto : descobertos) {
//            if (!descoberto) {
//                return false;
//            }
//        }
